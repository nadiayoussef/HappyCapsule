...
import { useNavigate } from 'react-router-dom'; // useNavigate now works because we're in a Router context
import { Routes, Route } from 'react-router-dom'; // Only import Routes and Route here
import LockCapsule from './LockCapsule'; // Import the Lock Capsule page
